...
func Test_Timestamp_LocalTimeZone_ParseCsvHeaders(t *testing.T) {
	tests := []struct {
		name  string
		input []string
	}{
		{"Annotated", []string{"CreatedAt[timestamp_ltz()]", "UpdatedAt[timestamp_ltz(yyyy-MM-ddTHH:mm:ssZ)]", "DeletedAt[timestamp_ltz(MM/dd/yyyy HH:mm:ss,3)]"}},
	}
...
SELECT '2000-12-31 23:59:59'::TIMESTAMP_LTZ(9) AS CREATEDAT, '2000-12-31 23:59:59'::TIMESTAMP_LTZ(4) AS UPDATEDAT, '2000-12-31 23:59:59'::TIMESTAMP_LTZ(3) AS DELETEDAT
UNION ALL
SELECT '1990-01-01 00:00:00'::TIMESTAMP_LTZ(9) AS CREATEDAT, '1990-01-01 00:00:00'::TIMESTAMP_LTZ(4) AS UPDATEDAT, '1990-01-01 00:00:00'::TIMESTAMP_LTZ(3) AS DELETEDAT
UNION ALL
SELECT '1980-06-15 12:30:45'::TIMESTAMP_LTZ(9) AS CREATEDAT, '1980-06-15 12:30:45'::TIMESTAMP_LTZ(4) AS UPDATEDAT, '1980-06-15 12:30:45'::TIMESTAMP_LTZ(3) AS DELETEDAT
`)
