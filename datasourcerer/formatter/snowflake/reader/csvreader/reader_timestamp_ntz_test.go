...
func Test_Timestamp_NoTimeZone_ParseCsvHeaders(t *testing.T) {
	tests := []struct {
		name  string
		input []string
	}{
		{"Annotated", []string{"CreatedAt[timestamp_ntz()]", "UpdatedAt[timestamp_ntz(yyyy-MM-ddTHH:mm:ssZ)]", "DeletedAt[timestamp_ntz(MM/dd/yyyy HH:mm:ss,3)]"}},
	}
...
SELECT '2000-12-31 23:59:59'::TIMESTAMP_NTZ(9) AS CREATEDAT, '2000-12-31 23:59:59'::TIMESTAMP_NTZ(4) AS UPDATEDAT, '2000-12-31 23:59:59'::TIMESTAMP_NTZ(3) AS DELETEDAT
UNION ALL
SELECT '1990-01-01 00:00:00'::TIMESTAMP_NTZ(9) AS CREATEDAT, '1990-01-01 00:00:00'::TIMESTAMP_NTZ(4) AS UPDATEDAT, '1990-01-01 00:00:00'::TIMESTAMP_NTZ(3) AS DELETEDAT
UNION ALL
SELECT '1980-06-15 12:30:45'::TIMESTAMP_NTZ(9) AS CREATEDAT, '1980-06-15 12:30:45'::TIMESTAMP_NTZ(4) AS UPDATEDAT, '1980-06-15 12:30:45'::TIMESTAMP_NTZ(3) AS DELETEDAT
`)
